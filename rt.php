...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($Nombre) || empty($Apellido) || empty($Edad) || empty($Email) || empty($Telefono) || empty($Identificacion)) {
        echo "Por favor, completa todos los campos del cliente antes de reservar.";
    } else {
